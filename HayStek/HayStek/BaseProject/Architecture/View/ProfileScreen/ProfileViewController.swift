...
class ProfileViewController: UIViewController {
    ...
    weak private var viewModel: ProfileViewModel?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        customNavigationBar = CutomerNavigationBar.addCustomNavigationBarOnVC(vcToAddNavigation: self, screenName: .ProfileViewController)
